...
const trackingSchema = new Schema({
  ...
  // Estado financiero/ejecución exclusivo de seguimientos extraordinarios
  extraordinaryStatus:  { type: String, enum: ['Pendiente', 'Ejecutado', 'Cobrado'], default: null },
...
trackingSchema.index({ extraordinaryStatus: 1 });
