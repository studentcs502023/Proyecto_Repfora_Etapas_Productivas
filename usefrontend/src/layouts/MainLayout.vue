    ...
    <q-header elevated class="bg-primary">
      <q-toolbar>
        ...
        <q-toolbar-title class="text-weight-bold">
          REPFORA <span class="text-subtitle2 q-ml-sm text-weight-regular text-grey-3">SENA</span>
        </q-toolbar-title>
      ...
      <q-scroll-area class="fit" style="height: calc(100% - 150px); margin-top: 10px;">
        <q-list padding>
          ...
          <template v-if="authStore.isApprentice">
            ...
            <q-item clickable v-ripple to="/my-productive-stage">
              <q-item-section avatar><q-icon name="assignment" /></q-item-section>
              <q-item-section>Mi Registro</q-item-section>
            </q-item>
