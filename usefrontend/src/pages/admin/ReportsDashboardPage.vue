<template>
  <div class="reports-dashboard-container q-pa-md">
    <div class="row items-center q-mb-md">
      <div class="col">
        <h2 class="text-h4 text-secondary text-weight-bold q-my-none">Panel de Reportes</h2>
      ...
      <div class="row q-col-gutter-md q-mb-lg" v-if="epSummary">
        ...
        <div class="col-12 col-md-9">
          <q-card flat bordered class="q-pa-md">
            <div class="text-subtitle2 text-secondary q-mb-sm">Por Estado</div>
            ...
            <div class="text-subtitle2 text-secondary q-mb-sm">Por Modalidad</div>
            <q-list dense>
