<template>
  <div class="admin-novelties-container q-pa-md">
    <div class="row items-center q-mb-md">
      <div class="col">
        <h2 class="text-h4 text-secondary text-weight-bold q-my-none">Gestión de Novedades</h2>
    ...
    <q-card flat bordered>
      ...
      >
        ...
        <template v-slot:body-cell-type="props">
          <q-td :props="props">
            <div class="text-weight-bold text-secondary">{{ getTypeLabel(props.value) }}</div>
          </q-td>
        </template>
        ...
        <q-card-section class="col q-pa-lg scroll">
          <div class="row q-col-gutter-lg">
            ...
            <div class="col-12 col-md-6">
              <div class="text-h6 text-secondary q-mb-md">Detalles del Incidente</div>
            ...
            <div class="col-12 col-md-6">
              <div class="text-h6 text-secondary q-mb-md">Resolución</div>
