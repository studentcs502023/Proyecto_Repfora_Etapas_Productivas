<template>
  <div class="approvals-container q-pa-md">
    <div class="row items-center q-mb-md">
      <div class="col">
        <h2 class="text-h4 text-secondary text-weight-bold q-my-none">Bandeja de Aprobaciones</h2>
        ...
        <q-card-section class="col q-pa-lg scroll">
          <div class="row q-col-gutter-lg">
            ...
            <div class="col-12 col-md-6">
              <div class="text-h6 text-secondary q-mb-md">Detalles de la Solicitud</div>
            ...
            <div class="col-12 col-md-6">
              <div class="text-h6 text-secondary q-mb-md">Aprobación y Asignación</div>
