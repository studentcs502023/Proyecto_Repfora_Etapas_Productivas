<template>
  <div class="close-ep-container q-pa-md">
    <div class="row items-center q-mb-md">
      <div class="col">
        <h2 class="text-h4 text-secondary text-weight-bold q-my-none">Cierre de Etapa Productiva</h2>
        ...
        <q-card-section class="col q-pa-lg scroll">
          <div class="row q-col-gutter-lg">
            ...
            <div class="col-12 col-md-7">
              <div class="text-h6 text-secondary q-mb-md">Documentos Obligatorios</div>
            ...
            <div class="col-12 col-md-5">
              <div class="text-h6 text-secondary q-mb-md">Cierre Definitivo</div>
