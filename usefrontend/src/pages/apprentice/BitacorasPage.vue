<template>
  <div class="bitacoras-container q-pa-md">
    <div class="row items-center q-mb-md">
      <div class="col">
        <h2 class="text-h4 text-secondary text-weight-bold q-my-none">Mis Bitácoras</h2>
    ...
    <q-dialog v-model="showDetailsModal">
      <q-card style="width: 600px; max-width: 90vw;">
        ...
        <q-card-section class="q-pa-md scroll" style="max-height: 60vh;">
          ...
          <div class="text-subtitle2 text-secondary q-mb-sm">Comentarios del Instructor</div>
...
async function submitBitacora() {
  ...
  try {
    ...
    console.error(error);
    const msg = error.response?.data?.message || 'Error al subir la bitácora.';
