<template>
  <div class="my-ep-container q-pa-md">
    <div class="row items-center q-mb-md">
      <div class="col">
        <h2 class="text-h4 text-secondary text-weight-bold q-my-none">Mi Etapa Productiva</h2>
      ...
      <div class="col-12 col-md-8">
        ...
        <q-card flat bordered class="q-mb-lg">
          <q-card-section class="bg-grey-2">
            <div class="text-subtitle1 text-weight-bold text-secondary">Detalles del Vínculo</div>
          </q-card-section>
        ...
        <q-card flat bordered v-if="ep.status !== 'PENDING_REGISTRATION' && ep.status !== 'PENDING_APPROVAL'">
          <q-card-section class="bg-grey-2">
            <div class="text-subtitle1 text-weight-bold text-secondary">Instructores Asignados</div>
          </q-card-section>
          <q-card-section>
